...
for model in MODELS:
    ...
    input_file = f"{RESULTS_DIR}/{model}_pass2_predictions.jsonl"
    output_file = f"{RESULTS_DIR}/{model}_pass2_results.jsonl"
    ...
    temp_file = f"/tmp/{model}_pass2_expanded.jsonl"
    ...
    print(f"Expanded candidates: {len(data) * 2}")
