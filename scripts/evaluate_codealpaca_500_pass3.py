...
input_file = f"{RESULTS_DIR}/codealpaca_500_pass3_predictions.jsonl"
output_file = f"{RESULTS_DIR}/codealpaca_500_pass3_results.jsonl"
temp_file = "/tmp/codealpaca_500_pass3_expanded.jsonl"

with open(input_file, encoding="utf-8") as f:
    data = [json.loads(line) for line in f]

print("=" * 70)
print("CODE-ALPACA-500 PASS@3 FUNCTIONAL EVALUATION")
print("=" * 70)
...
print("\n" + "=" * 70)
print("CODE-ALPACA-500 PASS@3 FUNCTIONAL EVALUATION COMPLETE")
print("=" * 70)
