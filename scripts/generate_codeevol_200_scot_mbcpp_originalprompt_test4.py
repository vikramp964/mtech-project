...
def build_scot_prompt(problem_prompt):
    ...
    return (
        ...
        "Pay careful attention to the function signature, parameter meanings, "
        "array/vector indexing, and whether parameters such as m and n refer "
        "to actual indices or dimensions. The solving process must match the "
        "given function signature and examples exactly. "
        "Use the examples in the requirement to infer any unstated "
        "algorithmic constraints, such as allowed moves or boundary "
        "conditions. Do not assume a standard variant if the examples "
        "indicate a different variant. "
        "Keep the solving process concise and structured; do not add long "
...
def build_code_prompt(problem_prompt, scot):
    ...
    if REQUIRE_COMPLETE_BODY:
        code_instruction = (
            ...
            "Include ALL required variable declarations, data "
            "structures, initialization, loops, conditionals, and "
            "the final return statement.\n"
            "Carefully follow the parameter meanings and indexing "
            "used in the requirement and examples.\n"
            "Keep the code concise. Do not add explanations.\n"
...
print(f"  Complete body       : {REQUIRE_COMPLETE_BODY}")
